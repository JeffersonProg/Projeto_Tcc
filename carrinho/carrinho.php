	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a href="../../projeto_tcc/pages/vitrine.php">Lista de Produtos</a>
	    	</div>
		</div>
		...
		<?php if($resultsCarts) : ?>
			...
			<a class="btn btn-success" style="float:right" target="_blank" href="../../projeto_tcc/pages/pagamento.php?valor=<?php echo $totalCarts;?>">Finalizar Compra</a>
